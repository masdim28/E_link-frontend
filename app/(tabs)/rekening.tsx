...
    setIsLoading(true);
    try {
      // Pastikan openDatabase sudah memanggil ensureRekeningTable()
...
      {/* Tombol tambah (diaktifkan, perbaikan error TS2322) */}
      // app/(tabs)/rekening.tsx
// ...
      <View style={styles.fabContainer}>
        <TouchableOpacity 
            style={styles.addButton} 
            activeOpacity={0.7}
            // --- Menggunakan 'as any' sebagai Workaround untuk Type-Error ---
...
// Style dideklarasikan secara lengkap untuk menghindari error
