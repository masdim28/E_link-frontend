...
const styles = StyleSheet.create({
  ...
  topHeader: { backgroundColor: '#00A86B', paddingTop: 35, paddingBottom: 20, borderBottomLeftRadius: 20, borderBottomRightRadius: 20, flexDirection: 'row', alignItems: 'center' },
